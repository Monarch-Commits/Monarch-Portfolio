  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        // No animation on mobile, fade on sm+
        'sm:data-[state=open]:animate-in sm:data-[state=closed]:animate-out sm:data-[state=closed]:fade-out-0 sm:data-[state=open]:fade-in-0 animate-none duration-0 sm:duration-200',
        className,
      )}
      {...props}
    />
